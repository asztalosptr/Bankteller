...
checking_balance, savings_balance =  make_deposit('savings', 200, checking_balance, savings_balance)
...
checking_balance, savings_balance = make_withdrawal('savings', 100, checking_balance, savings_balance)
print(check_balance('savings', checking_balance, savings_balance))
checking_balance, savings_balance = make_withdrawal('checking', 100, checking_balance, savings_balance)
print(check_balance('checking', checking_balance, savings_balance))

checking_balance, savings_balance = acc_transfer('checking', 'savings', 500, checking_balance, savings_balance)
print(check_balance('checking', checking_balance, savings_balance))
checking_balance, savings_balance = acc_transfer('savings', 'checking', 100, checking_balance, savings_balance)
print(check_balance('savings', checking_balance, savings_balance))
